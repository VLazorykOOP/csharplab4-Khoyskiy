...
public static bool operator true(MatrixUshort matrix)
    ...
    public static MatrixUshort operator +(MatrixUshort matrix1, MatrixUshort matrix2)
    {
        ...
        {
            throw new ArgumentNullException("Вхідні матриці не можуть бути нульовими.");
        }
        if (matrix1.n != matrix2.n || matrix1.m != matrix2.m)
        {
            throw new ArgumentException("Розмірності матриць повинні бути однаковими.");
        }
    ...
    public static MatrixUshort operator /(MatrixUshort matrix1, ushort scalar)
    {
        ...
        for (int i = 0; i < matrix1.n; i++)
        {
            for (int j = 0; j < matrix1.m; j++)
            {
                if (scalar == 0)
                {
                    throw new InvalidOperationException("Не допустиме ділення на 0");
                }
